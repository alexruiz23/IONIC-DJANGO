      ...
      this.misLibros = [
        {
          ...
          descripcion:
            'Primera parte de El Archivo de las Tormentas, donde seguimos a Kaladin, Shallan y Dalinar en el mundo de Roshar',
        ...
        },
        {
          ...
          autor: 'Brandon Sanderson',
          descripcion:
            'Primer libro de Mistborn, donde una banda de ladrones planea derrocar al Lord Legislador inmortal',
          genero: 'Fantasía',
        ...
        },
        {
          ...
          autor: 'Brandon Sanderson',
          descripcion:
            'Segunda parte de Mistborn, donde Vin y el resto luchan por mantener un reino libre',
          genero: 'Fantasía',
        ...
        },
        {
          ...
          autor: 'Brandon Sanderson',
          descripcion:
            'Primera novela publicada de Sanderson, sobre una ciudad mágica caída en desgracia',
          genero: 'Fantasía',
        ...
        },
        {
          ...
          autor: 'Brandon Sanderson',
          descripcion:
            'Segunda parte de El Archivo de las Tormentas, continuando la épica historia en Roshar',
          genero: 'Fantasía épica',
        ...
        },
        {
          ...
          autor: 'Brandon Sanderson',
          descripcion:
            'Tercera parte de Mistborn, el épico final de la primera trilogía',
          genero: 'Fantasía',
        ...
        },
        {
          ...
          autor: 'Brandon Sanderson',
          descripcion:
            'Tercera parte de El Archivo de las Tormentas, expandiendo los misterios de Roshar',
          genero: 'Fantasía épica',
        ...
        },
        {
          ...
          autor: 'Brandon Sanderson',
          descripcion:
            'Cuarta parte de El Archivo de las Tormentas, intensificando el conflicto en Roshar',
          genero: 'Fantasía épica',
        ...
        },
        {
          ...
          autor: 'Brandon Sanderson',
          descripcion:
            'Cuarta parte de Mistborn, comenzando una nueva era en Scadrial',
          genero: 'Fantasía',
        ...
        },
        {
          ...
          autor: 'Brandon Sanderson',
          descripcion:
            'Quinta parte de Mistborn, continuando las aventuras de Wax y Wayne',
          genero: 'Fantasía',
        ...
        },
        {
          ...
          autor: 'Brandon Sanderson',
          descripcion:
            'Sexta parte de Mistborn, culminación de la historia de Wax y Wayne',
          genero: 'Fantasía',
